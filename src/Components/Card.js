...
function Card(props) {
    ...
    return (
        <div className="card">
            ...
            <div className={`img-div ${!loader?"":"d-flex justify-content-center align-items-center"}`} style={{backgroundColor:`${loader?"black":""}`}} >{loader?<Loader/>:<img src={`http://localhost:3000/${props?.imgdata?.img?.path}`} alt="photu" id="photu" />}</div>
